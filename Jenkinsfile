...
pipeline {
    ...
    environment {
        author_name = "Mario Santa Cruz,Antonio Perez,Javier Diez"
        author_email = "santacruzm@predictia.es"
        app_name = "reanalysis_downscaler"
        job_location = "Pipeline-as-code/DEEP-OC-org/DEEP-OC-reanalysis_downscaler/${env.BRANCH_NAME}"
    }
